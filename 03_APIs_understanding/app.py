...
# print("json",response.json()) #does the conevrsion behind the secene automatiaclly we dont need to use json.load()
...
# #DELETE method
# response=requests.delete('https://jsonplaceholder.typicode.com/posts/5?userId=5')
# print(response.json())
